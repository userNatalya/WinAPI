#include<Windows.h>
#include"resource.h"
CONST CHAR g_sz_DEFAULT_LOGIN_MESSAGE[] = "Введите имя пользователя:";
//g-Глобальная область видимости,sz-стринг
		...
		case IDC_EDIT_LOGIN:
			...
			if (HIWORD(wParam) == EN_KILLFOCUS)
			{
				...
				if (strcmp(sz_buffer, "") == 0)
					SendMessage(hEdit, WM_SETTEXT, 0, (LPARAM)g_sz_DEFAULT_LOGIN_MESSAGE);
